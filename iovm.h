...
enum iovm1_error {
    ...
    IOVM1_ERROR_MEMORY_TARGET_UNDEFINED,
    IOVM1_ERROR_MEMORY_TARGET_NOT_READABLE,
    IOVM1_ERROR_MEMORY_TARGET_NOT_WRITABLE,
    IOVM1_ERROR_MEMORY_TARGET_ADDRESS_OUT_OF_RANGE,
